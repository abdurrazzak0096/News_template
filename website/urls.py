...
path('contact1/',views.Contact1View.as_view(),name='contact1'),
          path('contact-2/', views.ContactUsV2View.as_view(), name='contact-2'),
          path('contact2/', views.Contact2View.as_view(),name='contact2'),
...
path('portfolio-col-1-style-1/', views.PortfolioCol1Style1View.as_view(), name='portfolio-col-1-style-1'),
path('portfolio-col-1-style-2/', views.PortfolioCol1Style2View.as_view(), name='portfolio-col-1-style-2'),
path('portfolio-col-2-style-1/', views.PortfolioCol2Style1View.as_view(), name='portfolio-col-2-style-1'),
path('portfolio-col-2-style-2/', views.PortfolioCol2Style2View.as_view(), name='portfolio-col-2-style-2'),
path('portfolio-col-2-style-3/', views.PortfolioCol2Style3View.as_view(), name='portfolio-col-2-style-3'),
path('portfolio-col-2-style-4/', views.PortfolioCol2Style4View.as_view(), name='portfolio-col-2-style-4'),
path('portfolio-col-2-style-5/', views.PortfolioCol2Style5View.as_view(), name='portfolio-col-2-style-5'),
path('portfolio-col-2-style-6/', views.PortfolioCol2Style6View.as_view(), name='portfolio-col-2-style-6'),
path('portfolio-col-3-style-1/', views.PortfolioCol3Style1View.as_view(), name='portfolio-col-3-style-1'),
path('portfolio-col-3-style-2/', views.PortfolioCol3Style2View.as_view(), name='portfolio-col-3-style-2'),
path('portfolio-col-3-style-3/', views.PortfolioCol3Style3View.as_view(), name='portfolio-col-3-style-3'),
path('portfolio-col-3-style-4/', views.PortfolioCol3Style4View.as_view(), name='portfolio-col-3-style-4'),
path('portfolio-col-3-style-5/', views.PortfolioCol3Style5View.as_view(), name='portfolio-col-3-style-5'),
path('portfolio-col-4-style-1/', views.PortfolioCol4Style1View.as_view(), name='portfolio-col-4-style-1'),
path('portfolio-col-4-style-2/', views.PortfolioCol4Style2View.as_view(), name='portfolio-col-4-style-2'),
path('portfolio-col-4-style-3/', views.PortfolioCol4Style3View.as_view(), name='portfolio-col-4-style-3'),
path('portfolio-col-4-style-4/', views.PortfolioCol4Style4View.as_view(), name='portfolio-col-4-style-4'),
